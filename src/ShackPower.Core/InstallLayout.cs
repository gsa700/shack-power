...
public static class InstallLayout
{
    ...
    /// <c>%LOCALAPPDATA%\Programs\Shack Power</c>. Human-readable rather than RID-suffixed, matching
    /// the convention the other station tools use.
    /// </summary>
    public const string ProductFolder = "Shack Power";
    ...
    /// </summary>
    public const string ProductFolderUnix = "shack-power";
    ...
    /// copies ended up in <c>ShackPower-win-x64</c> before there was an installer — including the one
    ...
    [
        "ShackPower",
        "ShackPower-win-x64",
        "ShackPower-linux-x64",
        "ShackPower-linux-arm64",
    ];
    ...
    /// <c>%LOCALAPPDATA%\Programs</c> yields <c>%LOCALAPPDATA%\Programs\Shack Power</c>.
    /// </summary>
