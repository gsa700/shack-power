...
{
    const int Pid = 4242;
    const string Staged = "/tmp/ShackPower-update/ex/ShackPower";
    const string Target = "/opt/ShackPower/ShackPower";
    const string Marker = "/opt/ShackPower/.ShackPower-update-failed";
    const string WorkDir = "/opt/ShackPower";
    const string StageRoot = "/tmp/ShackPower-update";
    const string ScriptPath = "/tmp/ShackPower-apply-update.sh";
