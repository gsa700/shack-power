...
{
    private const string Exec = "/home/ab0r/.local/share/shack-power/ShackPower";

    [Fact]
    public void HasTheRequiredKeys()
    {
        var s = DesktopEntry.Build("Shack Power", Exec);
        Assert.StartsWith("[Desktop Entry]", s);
        Assert.Contains("Type=Application", s);
        Assert.Contains("Name=Shack Power", s);
    ...
    public void APathWithSpacesSurvivesQuoting()
    {
        ...
        var p = "/home/ab0r/.local/share/Shack Power/ShackPower";
    ...
    public void TheIconLineIsOmittedRatherThanLeftEmpty()
    {
        ...
        var s = DesktopEntry.Build("Shack Power", Exec, iconPath: null);
    ...
    {
        var icon = "/home/ab0r/.local/share/icons/hicolor/256x256/apps/shack-power.png";
        Assert.Contains($"Icon={icon}", DesktopEntry.Build("Shack Power", Exec, iconPath: icon));
    }
    ...
    {
        var s = DesktopEntry.Build("Shack Power", Exec, categories: ["Network"]);
    ...
    {
        // Avalonia reports the assembly name as the X11 class; "ShackPower" is what ShackPower.App produces.
        Assert.Equal("ShackPower", DesktopEntry.WindowClass);
    ...
    {
        var s = DesktopEntry.Build("Shack Power", Exec, iconPath: "/tmp/i.png", comment: "Wattmeter");
